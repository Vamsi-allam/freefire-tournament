...
const ResultsManagementModal = ({ isOpen, onClose, matchData, onPrizesCredited }) => {
    ...
    const computeToDistribute = () => {
        try {
            ...
            if (isClash) {
                // Winner takes 85% of total collected
    ...
    const winnersSetCount = (() => {
        ...
        if (isClash) return participants.filter(p => (Number(p.position) || 0) === 1).length;
                                                            ...
                                                            return (
                                                                <div className="actions-section">
                                                                    ...
                                                                    {anyEligible && !canCredit && (
                                                                        <div className="all-credited-note" style={{marginLeft:'12px'}}>All eligible prizes are credited.</div>
                                                                    )}
                                                                </div>
                                                            );
                                                        })()}
